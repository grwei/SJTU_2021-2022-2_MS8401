...
for i = 1:length(fig_name)
    test2_plot1_1(results_ideal,indices_name_group(i,1),indices_name_group(i,2),title_group(i,1),title_group(i,2),fig_name(i),file_name(i),create_fig_EN,export_fig_EN);
end
...
function [] = test2_plot1_1(results_ideal,indices_name1,indices_name2,title1,title2,fig_name,file_name,create_fig_en,export_fig_en)
...
legend(t_axes,'box','off','Orientation','vertical','NumColumns',3,'Location','northwest');
